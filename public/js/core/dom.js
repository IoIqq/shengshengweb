...
function createDOMProxy() {
  ...
  const elementIds = {
    ...
    deviceViewTable: 'device-view-table',
    deviceViewGrid: 'device-view-grid',
    deviceDrawer: 'device-drawer',
    deviceDrawerTitle: 'device-drawer-title',
    deviceDrawerClose: 'device-drawer-close',
    deviceDrawerOverlay: 'device-drawer-overlay',
    deviceStatusPopover: 'device-status-popover',
    ...
    borrowFormSubmit: 'borrow-form-submit',
    borrowFormCancel: 'borrow-form-cancel',
    borrowList: 'borrow-list',
    borrowRefreshBtn: 'borrow-refresh-btn',
    borrowAddBtn: 'borrow-add-btn',
    borrowFilters: 'borrow-filters',
    borrowSearch: 'borrow-search',
    borrowDeviceSelect: 'borrow-device-select',
    borrowViewTable: 'borrow-view-table',
    borrowViewGrid: 'borrow-view-grid',
    borrowDrawer: 'borrow-drawer',
    borrowDrawerTitle: 'borrow-drawer-title',
    borrowDrawerClose: 'borrow-drawer-close',
    borrowDrawerOverlay: 'borrow-drawer-overlay',
    // 团队协作
    teamGrid: 'team-grid',
