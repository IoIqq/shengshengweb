...
import { request, requestJSON, readCookie } from './utils/api.js';
...
//
// 缓存：浏览器原生 ES Module 加载是天然单例，loadModules() 可重复调用
//
// 模块占位（在 ensureModulesLoaded 完成前调用 render* 是安全的：直接 no-op）
let mods = null;
...
async function ensureModulesLoaded() {
  ...
  mods = { dashboard, media, todo, team, device, borrow, settings, users, audit };
  return mods;
}

// 渲染函数代理（在模块加载前调用 → 静默跳过；加载后 → 调真实方法）
const renderDashboard = (...args) => mods?.dashboard?.renderDashboard?.(...args);
const renderActivity = (...args) => mods?.dashboard?.renderActivity?.(...args);
const initActivityFilters = (...args) => mods?.dashboard?.initActivityFilters?.(...args);
const renderMedia = (...args) => mods?.media?.renderMedia?.(...args);
const renderReview = (...args) => mods?.media?.renderReview?.(...args);
const reviewMedia = (...args) => mods?.media?.reviewMedia?.(...args);
const deleteMedia = (...args) => mods?.media?.deleteMedia?.(...args);
const toggleMediaSelection = (...args) => mods?.media?.toggleMediaSelection?.(...args);
const clearMediaSelection = (...args) => mods?.media?.clearMediaSelection?.(...args);
const batchReviewMedia = (...args) => mods?.media?.batchReviewMedia?.(...args);
const initUploadDialog = (...args) => mods?.media?.initUploadDialog?.(...args);
const openUploadDialog = (...args) => mods?.media?.openUploadDialog?.(...args);
const renderTodos = (...args) => mods?.todo?.renderTodos?.(...args);
const createTodo = (...args) => mods?.todo?.createTodo?.(...args);
const toggleTodo = (...args) => mods?.todo?.toggleTodo?.(...args);
const deleteTodo = (...args) => mods?.todo?.deleteTodo?.(...args);
const startEditTodo = (...args) => mods?.todo?.startEditTodo?.(...args);
const cancelEditTodo = (...args) => mods?.todo?.cancelEditTodo?.(...args);
const saveEditTodo = (...args) => mods?.todo?.saveEditTodo?.(...args);
const renderTeam = (...args) => mods?.team?.renderTeam?.(...args);
const createTeamMember = (...args) => mods?.team?.createTeamMember?.(...args);
const deleteTeamMember = (...args) => mods?.team?.deleteTeamMember?.(...args);
const moveTeamMember = (...args) => mods?.team?.moveTeamMember?.(...args);
const startEditTeamMember = (...args) => mods?.team?.startEditTeamMember?.(...args);
const cancelEditTeamMember = (...args) => mods?.team?.cancelEditTeamMember?.(...args);
const saveEditTeamMember = (...args) => mods?.team?.saveEditTeamMember?.(...args);
const loadTeamContribution = (...args) => mods?.team?.loadTeamContribution?.(...args);
const renderDevices = (...args) => mods?.device?.renderDevices?.(...args);
const createDevice = (...args) => mods?.device?.createDevice?.(...args);
const updateDevice = (...args) => mods?.device?.updateDevice?.(...args);
const deleteDevice = (...args) => mods?.device?.deleteDevice?.(...args);
const startEditDevice = (...args) => mods?.device?.startEditDevice?.(...args);
const cancelEditDevice = (...args) => mods?.device?.cancelEditDevice?.(...args);
const setDeviceImagePreview = (...args) => mods?.device?.setDeviceImagePreview?.(...args);
const uploadDeviceImage = (...args) => mods?.device?.uploadDeviceImage?.(...args);
const loadDeviceOptions = (...args) => mods?.device?.loadDeviceOptions?.(...args);
const syncDeviceView = (...args) => mods?.device?.syncDeviceView?.(...args);
const refreshDevices = (...args) => mods?.device?.refreshDevices?.(...args);
const renderBorrowRequests = (...args) => mods?.borrow?.renderBorrowRequests?.(...args);
const createBorrowRequest = (...args) => mods?.borrow?.createBorrowRequest?.(...args);
const approveBorrowRequest = (...args) => mods?.borrow?.approveBorrowRequest?.(...args);
const returnBorrowRequest = (...args) => mods?.borrow?.returnBorrowRequest?.(...args);
const deleteBorrowRequest = (...args) => mods?.borrow?.deleteBorrowRequest?.(...args);
const syncBorrowView = (...args) => mods?.borrow?.syncBorrowView?.(...args);
const refreshBorrowRequests = (...args) => mods?.borrow?.refreshBorrowRequests?.(...args);
const renderBorrowDeviceSelect = (...args) => mods?.borrow?.renderBorrowDeviceSelect?.(...args);
const renderSettings = (...args) => mods?.settings?.renderSettings?.(...args);
const updateSettings = (...args) => mods?.settings?.updateSettings?.(...args);
const copyToClipboard = (...args) => mods?.settings?.copyToClipboard?.(...args);
...
function bindDeviceEvents() {
  ...
  if (els.deviceImageBtn && els.deviceImageFile) {
    els.deviceImageBtn.addEventListener('click', () => els.deviceImageFile.click());
  ...
  if (els.deviceImageClear) {
    els.deviceImageClear.addEventListener('click', () => setDeviceImagePreview(''));
  }
